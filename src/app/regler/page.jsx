    ...
    return (
        <div className={styles.gridContainer}>
            <div className={styles.textcol}>
                ...
                <p>Denne side indeholder en tabel over Axe's HTML 4.9 tilgængelighedsregler, designet til at guide webudviklere og designere i at opnå bedre digital tilgængelighed.</p>
            </div>
                ...
                <table className={styles.table}>
                    <thead>
                        <tr>
                            ...
                            <th className={styles.headerCell}>Beskrivelse</th>
...
{simonData.map((item, index) => (
  <tr key={item.slug} className={(index % 2 === 0) ? styles.tableRowEven : ''}>
    ...
    <td className={styles.dataCell}>{item.shortDesc}</td>
